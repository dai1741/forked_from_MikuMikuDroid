...
//		mEnglishBoneNameNum = 122;
	...
	private void parsePMDMaterialList(String path) {
		...
		if(mMaterialNum > 0) {
			...
			for(int i = 0; i < mMaterialNum; i++) {
				...
				material.face_color = new float[4];
				getFloat(material.face_color);
	...
	public int numVertex() { return mVertexNum; }
	public ArrayList<Vertex> getVertex() { return mVertex; }
	public int numIndex() { return mIndexNum; }
	public ArrayList<Integer> getIndex() { return mIndex; }
	public int numMaterial() { return mMaterialNum; }
	public ArrayList<Material> getMaterial() { return mMaterial; }
	public int numBone() { return mBoneNum; }
	public ArrayList<Bone> getBone() { return mBone; }
	public String getToonFileName(int i) { return mToonFileName.get(i); }
	public ArrayList<IK> getIK() { return mIK; }
	public ArrayList<Face> getFace() { return mFace; }
